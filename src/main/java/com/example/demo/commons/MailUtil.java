...
public class MailUtil {
	    ...
	    public static String sendmail() throws Exception {
	    	String a=(long)(Math.random()*10000)+"";
	    	Cookie cookie=new Cookie("a", a);
	    	cookie.setMaxAge(60);
	    	System.out.println(a);
	    	int res=sendEmail("smtp.qq.com", "1550526377@qq.com", "jcraptltfyvpjfgf", "1550526377@qq.com", new String[]{
	    			"13035805242@163.com" //这里就是一系列的收件人的邮箱了
	    	}, "用户注册", "验证码"+a,"text/html;charset=utf-8");
